...
val data = MLUtils.loadLibSVMFile(sc,"5Fea.txt")
var x=0;
//For( x<-1 to 5 )
//{
...
svmAlg.optimizer.setStepSize(0.01).setNumIterations(100).setRegParam(0.11).setMiniBatchFraction(0.1).setUpdater(new L1Updater())
